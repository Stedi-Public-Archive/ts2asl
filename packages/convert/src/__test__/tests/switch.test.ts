...
`);
    ...
    it("then switchCaseFallsThroughToDefault can be converted to asl", async () => {
        expect(converted.switchCaseFallsThroughToDefault.asl).toMatchInlineSnapshot(`
Object {
  "StartAt": "Initialize",
  "States": Object {
    "Assign arr": Object {
...
`);
    ...
    it("then switchWithBlock can be converted to asl", async () => {
        expect(converted.switchWithBlock.asl).toMatchInlineSnapshot(`
Object {
  "StartAt": "Initialize",
  "States": Object {
    "Assign arr": Object {
    ...
    "Switch (item)": Object {
      ...
      "Comment": "source: switch (item) { default: case 1: { result = \`$ ...",
      "Default": "Evaluate Format('{}not-th ...",
      "Type": "Choice",
    },
  },
